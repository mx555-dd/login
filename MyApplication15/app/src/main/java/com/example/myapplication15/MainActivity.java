...
import com.example.myapplication15.bean.UserInfo;
import com.example.myapplication15.database.UserDBHelper;
import com.example.myapplication15.util.DateUtil;
import com.example.myapplication15.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","18990036 麻绪"};
